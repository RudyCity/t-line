    ...
    <div className="welcome-card-outer">
      <div className="relative p-[1.5px] rounded-2xl bg-gradient-to-r from-purple-500/30 via-violet-600/30 to-cyan-500/30 shadow-[0_8px_30px_rgb(0,0,0,0.5)] overflow-hidden max-w-xl w-full">
        ...
        <div className="welcome-card-inner">
          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-purple-600/10 border border-purple-500/30 flex items-center justify-center text-purple-400 mb-6 sm:mb-8 shadow-[0_0_15px_rgba(168,85,247,0.15)] animate-pulse">
            <FolderPlus className="w-6 h-6 sm:w-8 sm:h-8" />
          </div>
          <h2 className="text-lg sm:text-xl font-bold tracking-tight mb-4 sm:mb-5 bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">
            Manage Workspaces & Git Worktrees
          </h2>
          <p className="text-xs sm:text-sm text-slate-400 max-w-xs sm:max-w-sm mb-8 sm:mb-10 leading-relaxed">

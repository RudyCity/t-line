    ...
    <div className="group relative p-4 rounded-xl bg-[var(--bg-card)] border border-amber-500/50 hover:border-amber-500 text-[var(--text-main)] space-y-3.5 shadow-xl backdrop-blur-md transition-all duration-200">
      ...
      <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-[var(--border-color)]">
        ...
        <button
          ...
          className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] active:scale-[0.98] text-white font-medium text-xs px-3.5 py-1.5 rounded-lg shadow-sm transition-all duration-150 cursor-pointer"
        >
...
export function QuestionCard({
  ...
  return (
    <div className="group relative p-4 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] hover:border-[var(--color-primary)]/50 text-[var(--text-main)] space-y-3.5 shadow-xl backdrop-blur-md transition-all duration-200">
      {/* Top Header Badge */}
            ...
            return (
              <div
                ...
                className={`flex items-start gap-2.5 p-2.5 rounded-lg border transition-all duration-150 cursor-pointer select-none text-xs ${
                  active
                    ? 'bg-[var(--color-primary-glow)] border-[var(--color-primary)] text-[var(--text-main)] shadow-sm ring-1 ring-[var(--color-primary)]/20'
      ...
      <div className="flex items-center justify-between pt-1 border-t border-[var(--border-color)]">
        ...
        <button
          ...
          className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] active:scale-[0.98] disabled:opacity-40 disabled:hover:bg-[var(--color-primary)] disabled:cursor-not-allowed disabled:active:scale-100 text-white font-medium text-xs px-4 py-1.5 rounded-lg shadow-sm hover:shadow-[var(--color-primary-glow)] transition-all duration-150 flex items-center gap-1.5 cursor-pointer"
        >
...
export function PlanCard({ pendingPlanApproval, handlePlanApproval }: PlanCardProps) {
  ...
  return (
    <div className="group relative p-4 rounded-xl bg-[var(--bg-card)] border border-[var(--color-primary)]/50 hover:border-[var(--color-primary)] text-[var(--text-main)] space-y-3.5 shadow-xl backdrop-blur-md transition-all duration-200">
      {/* Top Header Badge */}
      <div className="flex items-center gap-2">
        <span className="relative flex h-2 w-2">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[var(--color-primary)] opacity-75"></span>

...
export default function BookmarksDropdown({
  ...
  return (
    <div className="relative" ref={bookmarksDropdownRef}>
      ...
      {showBookmarksDropdown && (
        <div className="absolute right-0 mt-2 w-64 bg-[var(--bg-card)]/95 border border-[var(--border-color)] rounded-xl shadow-2xl z-[100] backdrop-blur-md p-2 flex flex-col animate-in fade-in slide-in-from-top-2 duration-150">

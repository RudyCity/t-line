  ...
  return (
    <div className="w-64 bg-[#090c14] border-r border-zinc-800/80 flex flex-col h-full shrink-0 select-none font-sans text-xs">
      ...
      <div className="p-3 border-b border-zinc-800/80 space-y-2.5">
        <button
          onClick={onNewChat}
          className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-medium py-2 px-3 rounded-lg shadow-sm hover:shadow transition flex items-center justify-center gap-2 text-xs cursor-pointer group"
          title="Create a new SuperAgent chat session"
        >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#121622] border border-zinc-800 rounded-md pl-8 pr-2.5 py-1.5 text-xs text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-indigo-500/80 transition"
          />
          {searchQuery && (
            <button
      ...
      <div className="px-3 py-2 flex items-center justify-between text-[10px] uppercase font-bold text-zinc-500 tracking-wider">

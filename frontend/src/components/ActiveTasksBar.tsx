...
export function ActiveTasksBar({
  ...
  return (
    <div className="mb-2 font-mono text-[11px] leading-relaxed max-h-44 overflow-y-auto scrollbar-thin select-none pl-1">
      <div className="relative border-l border-zinc-700/70 ml-2 pl-4 space-y-1 py-0.5">
        {items.map((item, index) => {
          ...
          return (
            <div key={item.key} className="relative flex items-center justify-between group py-0.5">
              ...
              <span className="absolute -left-[21px] text-zinc-600 font-bold select-none text-[11px]">
                {treeChar}
              </span>
